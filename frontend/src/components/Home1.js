      ...
      <div className="home1-body">
        ...
        <div className="promo-container">
          <div className="promo-card">
            <div className="promo-image">
              <img src="/images/booksale.jpg" alt="Sale" />
            </div>
          ...
          <div className="promo-card">
            <div className="promo-image">
              <img className="promo-img" src="/images/newarival.jpg" alt="New Arrivals" />
            </div>
            <div className="promo-content">
          ...
          <div className="promo-card">
            <div className="promo-image">
              <img className="promo-img" src="/images/more.jpg" alt="Book Collection" />
            </div>
            <div className="promo-content">
        ...
        <div className="genre-container">
          ...
          <div className="genre-box" onClick={() => navigate('/shop?genre=Non-Fiction')}>
            <img src="/images/nonfic.jpg" alt="Non-Fiction" />
